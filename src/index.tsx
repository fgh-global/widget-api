...
const factory: BlockFactory = (BaseBlockClass, widgetApi) => {
  ...
  return class UserprofileBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): UserprofileProps {
      const attrs = this.parseAttributes<UserprofileProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<Userprofile {...this.props} widgetApi={widgetApi}/>, container);
    }
